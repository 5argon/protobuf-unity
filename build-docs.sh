#!/usr/bin/env bash
#
# Build and preview the Protobuf Unity documentation site with DocFX.
#
...
#   3. Open src/protobuf-unity in Unity once so it generates the .sln / .csproj
...
watch_dirs=(
  ...
  "$repo_root/src/protobuf-unity/Assets/protobuf-unity/Documentation~"
  "$repo_root/src/protobuf-unity/Assets/protobuf-unity/CHANGELOG.md"
)
