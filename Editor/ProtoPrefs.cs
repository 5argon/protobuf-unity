...
namespace E7.Protobuf {
    internal static class ProtoPrefs {
        ...
        internal static readonly string prefUniqueToDirectory = "ProtobufUnity_UniqueToDirectory";

        internal static bool enabled {
            get { return EditorPrefs.GetBool(prefProtocEnable, true); }
        ...
        internal static bool logStandard {
            get { return EditorPrefs.GetBool(prefLogStandard, false); }
        ...
        internal static string grpcPath {
            ...
            set { EditorPrefs.SetString(prefGrpcPath, value); }
        }
